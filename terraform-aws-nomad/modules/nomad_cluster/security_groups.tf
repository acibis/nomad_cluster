...
// This rule allows Nomad ingress all traffic from our laptop
resource "aws_security_group_rule" "nomad_all_from_my_laptop" {
  security_group_id        = aws_security_group.nomad.id
  type                     = "ingress"
  from_port                = 0
  to_port                  = 0
...
// This rule allows db to interact
resource "aws_security_group_rule" "nomad_db" {
  security_group_id        = aws_security_group.nomad.id
  type                     = "egress"
  from_port                = 0
  to_port                  = 0
...
// This rule allows db to interact
resource "aws_security_group_rule" "db_from_security_group" {
  security_group_id        = aws_security_group.nomad.id
  type                     = "ingress"
  from_port                = 0
  to_port                  = 0
